...
let example0 = And [ Or [ test To "doligez"; test CC "doligez" ];
...
let ex0 = simplify (Not (And [ Or [Base "it's snowing"; Const true];
                               Base "it's raining"]))

let ex1 = simplify (Not (And [ Or [Base "it's snowing"; Const true];
